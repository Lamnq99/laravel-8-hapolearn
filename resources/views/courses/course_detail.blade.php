                    ...
                    <div class="nav-course-detail-container">
                        <ul class="nav nav-tabs nav-course-detail">
                            <li class="nav-item col-lg-2 pl-0">
                                <a class="nav-link active btn-nav-detail" id="href-lesson" data-toggle="tab"
                                    href="#lessons">Lessons</a>
                            </li>
                            <li class="nav-item col-lg-2 pl-0">
                                <a class="nav-link btn-nav-detail" id="href-teacher" data-toggle="tab"
                                    href="#teacher">Tearcher</a>
                            </li>
                            <li class="nav-item col-lg-2 pl-0">
                                <a class="nav-link btn-nav-detail" id="href-review" data-toggle="tab"
                    ...
                    <div class="lessons-teacher-reiews-container">
                        <div class="tab-content">
                            ...
                            <div id="reviews" class="tab-pane">
                                @include('courses._tab_review', [$course, $reviews, $totalRate, $avgRating])
                            </div>
                        </div>
                    </div>
                </div>
