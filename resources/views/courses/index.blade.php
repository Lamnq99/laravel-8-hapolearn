        ...
        <form class="form-inline" action="{{ route('search') }}" method="GET">
            <div class="filter-and-search row">
                <div class="filter-container">
                    <img class="filter-icon" src="{{ asset('images/filter.png') }}" alt="filter" data-toggle="collapse"
                ...
                <div class="container-fluid container-main-filter">
                    <div class="row p-0 row-filter-1">
                        ...
                        <div class="col-sm-3 btn-latest-oldest">
                            <input type="radio" class="btn-check" id="newest"
                                value="{{ config('constants.options.newest') }}" name="sort"
                                {{ request('sort') == "config('constants.options.newest')" ? 'checked' : '' }}>
                            <label class="btn btn-latest label-radio" for="newest">Latest</label>

                            <input type="radio" class="btn-check" id="oldest"
                                value="{{ config('constants.options.oldest') }}" name="sort"
