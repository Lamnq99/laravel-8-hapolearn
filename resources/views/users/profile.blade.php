        ...
        <form class="row main-profile" action="profile/edit" method="post" enctype="multipart/form-data">
            ...
            <div class="col-lg-4 profile align-self-center">
                ...
                <div class="description-user">
                    <img src="{{ asset('images/birthday_icon.png') }}" alt="phone icon">
                    <p class="txt-user">{{ $birthday }}</p>
                </div>
                <hr>
                <div class="description-user">
                    <img src="{{ asset('images/phone_user_icon.png') }}" alt="phone icon">
                    <p class="txt-user">{{ $users->phone }}</p>
                </div>
                <hr>
                <div class="description-user">
                    <img src="{{ asset('images/adress_icon.png') }}" alt="adress icon">
                    ...
                    <div class="row form-group ">
                        <div class="col-lg-6">
                            ...
                            <input placeholder="Select date" type="text" id="datepicker"
                                class="form-control edit-input-profile datepicker" value="{{ $users->birthday }}">
                        </div>
                        <div class="col-lg-6">
