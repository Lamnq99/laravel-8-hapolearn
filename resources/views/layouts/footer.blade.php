<footer class="container-fluid">
    <div class="content">
        <div class="logo">
            <img class="logo-footer" src="{{ asset('images/hapo_learn_white.png') }}" alt="logo HapoLearn">
        ...
        <div class="social-footer">
            <a href="#" onclick="return false" data-toggle="popover" data-trigger="hover" data-placement="bottom"
                ...
                <img class="img-icon" src="{{ asset('images/fb_icon.png') }}" alt="icon-face">
            </a>
            <a href="#" onclick="return false" data-toggle="popover" data-trigger="hover" data-placement="bottom"
                data-content="+84-85-645-9898">
                <img class="img-icon" src="{{ asset('images/phone_icon.png') }}" alt="phone_icon">
            </a>
            <a href="#" onclick="return false" data-toggle="popover" data-trigger="hover" data-placement="bottom"
                data-content="info@haposoft.com">
                <img class="img-icon" src="{{ asset('images/email_icon.png') }}" alt="email_icon">
            </a>
        </div>
    </div>
